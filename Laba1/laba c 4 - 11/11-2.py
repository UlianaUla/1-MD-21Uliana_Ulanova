...
class Restauranto:
    ...
    def describe_restauranto(self):
        print("Название ресторана - ",self.restauranto_name, end='\n', "Тип кухни - ",self.cuisine_type)
...
class Restaro:
    ...
    def describe_restaro(self):
        print("Название ресторана - ",self.restaro_name, end='\n', "Тип кухни - ",self.cuisine_type)
    def open_restaro(self):
        print("Ресторан открыт")
newRestaurant=Restaurant("Mama mia", "Итальянская")
newRestaurant1=Restauranto("Артемида", "Греческая")
newRestaurant2=Restaro("Берёзка", "Русская")

newRestaurant.describe_restaurant()
newRestaurant1.describe_restaurano()
